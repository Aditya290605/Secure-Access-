 ...
 *
 * Covers: validation, auth, authorization, data integrity, malformed requests,
 * and a catch-all that logs but doesn't leak internal details.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleDataIntegrity(DataIntegrityViolationException ex) {
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(errorBody("Conflict", "A record with this data already exists",
                        HttpStatus.CONFLICT));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleMalformedJson(HttpMessageNotReadableException ex) {
        return ResponseEntity.badRequest()
                .body(errorBody("Bad Request", "Malformed or missing request body",
                        HttpStatus.BAD_REQUEST));
    }
